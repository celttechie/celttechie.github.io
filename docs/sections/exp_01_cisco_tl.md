...
Managed FedRAMP operations for critical infrastructure for the Webex for Government (FedRAMP) platform. Responsible for driving technical strategy, mentoring engineering teams, and building automated tooling to enhance security posture and operational efficiency.
